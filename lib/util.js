 ...
 */
function loadCategory(categoryData, guild, rateLimitManager) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) {
                    rateLimitManager.resolver(guild.channels, 'create', categoryData.name, { type: 'category' }).then(function (category) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, rateLimitManager.resolver(category, 'overwritePermissions', finalPermissions)];
                                case 1:
                                    _a.sent();
 ...
 */
function loadChannel(channelData, guild, category, options, rateLimitManager) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        rateLimitManager.resolver(guild.channels, 'create', channelData.name, createOptions).then(function (channel) { return __awaiter(_this, void 0, void 0, function () {
                            var finalPermissions;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, rateLimitManager.resolver(channel, 'overwritePermissions', finalPermissions)];
                                    case 1:
                                        _a.sent();
                                        /* Load messages */
                                        if (channelData.type === 'text' && channelData.messages.length > 0) {
                                            rateLimitManager.resolver(channel, 'createWebhook', 'MessagesBackup', {
                                                avatar: channel.client.user.displayAvatarURL()
                                            })
                                                .then(function (webhook) { return __awaiter(_this, void 0, void 0, function () {
                                                var messages, _loop_1, _i, messages_1, msg;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                                    ...
                                                                    switch (_a.label) {
                                                                        case 0:
                                                                            ...
                                                                            msg.embeds.forEach(function (embed) {
                                                                                var clear = {};
                                                                                for (var _i = 0, _a = Object.entries(embed).filter(function (_a) {
                                                                                    var _ = _a[0], v = _a[1];
                                                                                    return !!v;
                                                                                }); _i < _a.length; _i++) {
                                                                                ...
                                                                                ;
                                                                                if (!!clear.url && !clear.description)
                                                                                    clear.description = "Embed include url";
                                                                                embedsClear.push(clear);
                                                                            });
                                                                            return [4 /*yield*/, rateLimitManager.resolver(webhook, 'send', msg.content, {
                                                                        ...
                                                                        case 1:
                                                                            sentMsg = _a.sent();
                                                                            if (!(msg.pinned && sentMsg)) return [3 /*break*/, 3];
                                                                            return [4 /*yield*/, rateLimitManager.resolver(sentMsg, 'pin')];
                                                                        case 2:
                                                                            _a.sent();
                                                                            _a.label = 3;
 ...
 */
function clearGuild(guild, rateLimitManager) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    guild.roles.cache
                        ...
                        rateLimitManager.resolver(role, 'delete').catch(function () { });
                    });
                    guild.channels.cache.forEach(function (channel) {
                        rateLimitManager.resolver(channel, 'delete').catch(function () { });
                    });
                    guild.emojis.cache.forEach(function (emoji) {
                        rateLimitManager.resolver(emoji, 'delete').catch(function () { });
                    });
                    return [4 /*yield*/, rateLimitManager.resolver(guild, 'fetchWebhooks')];
                case 1:
                    webhooks = _a.sent();
                    webhooks.forEach(function (webhook) {
                        rateLimitManager.resolver(webhook, 'delete').catch(function () { });
                    });
                    return [4 /*yield*/, rateLimitManager.resolver(guild, 'fetchBans')];
                case 2:
                    bans = _a.sent();
                    bans.forEach(function (ban) {
                        rateLimitManager.resolver(guild.members, 'unban', ban.user).catch(function () { });
                    });
                    return [4 /*yield*/, rateLimitManager.resolver(guild, 'fetchIntegrations')];
                case 3:
                    ...
                    rateLimitManager.resolver(guild, 'setBanner', null).catch(function () { });
                    rateLimitManager.resolver(guild, 'setSplash', null).catch(function () { });
