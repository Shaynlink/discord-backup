...
var load = function (backup, guild, options) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                    var backupData, _a, rateLimitManager, e_2, e_3;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 4:
                                ...
                                rateLimitManager = new ratelimit_1.RateLimitManager(50, 10000, typeof options.mode == 'string' ?
                            ...
                            case 5:
                                ...
                                // Clear the guild
                                return [4 /*yield*/, utilMaster.clearGuild(guild, rateLimitManager)];
                            case 6:
                                // Clear the guild
                                _b.sent();
                                _b.label = 7;
