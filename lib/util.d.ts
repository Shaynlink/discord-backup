 ...
 */
export declare function loadCategory(categoryData: CategoryData, guild: Guild, rateLimitManager: RateLimitManager): Promise<CategoryChannel>;
/**
 * Create a channel and returns it
 */
export declare function loadChannel(channelData: TextChannelData | VoiceChannelData, guild: Guild, category?: CategoryChannel, options?: LoadOptions, rateLimitManager?: RateLimitManager): Promise<unknown>;
/**
 * Delete all roles, all channels, all emojis, etc... of a guild
 */
export declare function clearGuild(guild: Guild, rateLimitManager: RateLimitManager): Promise<void>;
